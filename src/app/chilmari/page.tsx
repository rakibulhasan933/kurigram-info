...
export default async function Chilmari() {
	return (
		<main>
			<div className="flex flex-col items-center gap-2">
				<div className="w-full relative">
					...
					<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
						<h1 className=" md:text-4xl text-xl  text-center md:mb-12 mb-2 text-white font-extrabold uppercase ">Welcome To Chilmari</h1>
					</div>
				</div>
			</div>
			{/* Hero */}
