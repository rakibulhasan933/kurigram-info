			...
			<div className="flex flex-col items-center gap-2">
				<div className="w-full relative">
					...
					<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
						<h1 className=" md:text-4xl text-xl  text-center md:mb-12 mb-2 text-white font-extrabold uppercase ">Welcome To Ulipur</h1>
					</div>
				</div>
			</div>
			{/* Hero */}
			<div className="md:mx-3 mx-2 my-6">
				<div className="grid md:grid-cols-2  grid-cols-1 gap-2">
					...
					<div className="flex flex-col px-3 my-4">
						<h1 className=" text-center text-2xl font-bold mb-4">Ulipur District</h1>
						<p className=" font-light text-sm">Ulipur is the northernmost upazila of Kurigram District in the Division of Rangpur, Bangladesh.
						</p>
