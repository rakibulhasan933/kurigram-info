...
function Footer() {
	return (
		<div className='bg-slate-100 md:px-10 px-2 py-4'>
			<div>
				<div className='flex md:flex-row flex-col justify-between items-center py-4 px-2 md:gap-6 gap-3 rounded'>
					...
					<div className="md:basis-1/2 w-full flex flex-row items-center justify-between md:px-8 px-4">
