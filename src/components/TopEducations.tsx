	...
	return (
		<div className='my-4 mx-2 md:mx-6'>
			<div className="flex flex-row items-center justify-between mt-2">
				<h2 className="px-4 py-2 rounded md:text-xl text-lg font-medium text-white bg-pink-400 w-fit">Educational Institutions in Kurigram</h2>
				...
				<Link href="/">
					<div className="flex justify-center flex-col mt-4 rounded-md border-[1px] hover:border-pink-400 hover:border-2 shadow-lg">
						...
						<div className="px-2 py-4 flex flex-col gap-x-3">
							<h2 className="font-bold text-lg  hover:text-pink-400">Kurigram Govt Collage</h2>
							...
							<div className="flex justify-between">
								<div className="flex flex-row gap-y-2">
									<GraduationCapIcon className='w-10 text-pink-400' />
									<h2 className="text-lg font-medium">Collage</h2>
								</div>
