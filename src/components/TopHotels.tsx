"use client";
import { HeartIcon, HotelIcon, Loader2Icon, LocateFixedIcon, PhoneCallIcon } from 'lucide-react'
...
function TopHotels({ data }: { data: ServicesProps[] }) {
	return (
		<div className='my-4 mx-2 md:mx-6'>
			<div className="flex flex-row items-center justify-between mt-2">
				...
				<Link className=' px-4 py-2 hover:text-white w-fit hover:bg-pink-400 rounded text-sm text-pink-400 font-semibold border-2 border-pink-400' href="/hotels">More</Link>
			</div>
			<div className="my-4">
				<Swiper
