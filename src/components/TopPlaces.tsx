			...
			<div className="grid md:grid-cols-4 grid-cols-1 gap-3">
				<Link href="/">
					<div className="flex justify-center flex-col mt-4 rounded-md border-[1px] hover:border-pink-400 hover:border-2 shadow-lg">
						<Image src="/places.jpg" className=' rounded-md object-cover w-full' alt='room' width={300} height={200} priority={true} />
						<div className="px-2 py-4 flex flex-col gap-x-3">
							<h2 className="font-bold text-lg  hover:text-pink-400">Royal Palace of Madrid</h2>
							...
							<div className="flex justify-between">
								<div className="flex flex-row gap-y-2">
									<MapPinIcon className='w-10 text-pink-400' />
